...
lemma sse_concat: ∀f, e, y, y', H, H1, H2. sse (concat e f) y y' H = 
concat (sse e y y' H1) (sse f y y' H2).
@Environment_simple_ind2
[ #e #y #y' #H #H1 #H2 //
| #f * #z #b #HI #e #y #y' #H #H1 #H2 whd in match (concat ??);
 whd in match (sse ? ? ? ?);
 whd in match (sse (Cons ? ?) ? ? ?);
 cases (veqb)
 [ >if_t >if_t
