...
| lapply H cases s #y #t' whd in match (match psubst y t' in pifSubst return λ_:pifSubst.Variable with 
  ...
  normalize in match (t_size
           ...
           -1);
  @foo #k #k_def #k_size
  normalize >k_size >h normalize normalize in H; -H #H >H normalize
